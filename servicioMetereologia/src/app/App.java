...
import service.ServicioClimatologiaImpl;
import util.PrintUtil;

public class App {

	static ServicioClimatologiaImpl servicio;
	...
	public static void main(String[] args) {
		...
		servicio = new ServicioClimatologiaImpl(Init.getAll());
